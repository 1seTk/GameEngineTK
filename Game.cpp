...
void Game::Initialize(HWND window, int width, int height)
{
    ...
    */
	...
	ADX2Le::Initialize("Sounds\\test.acf");			// ADX2の初期化
	ADX2Le::LoadAcb("Sounds\\CueSheet_0.acb", "Sounds\\CueSheet_0.awb");		// 音の読み込み
...
void Game::Render()
{
	...
	primitiveBatch->DrawLine(
		// 頂点の指定
		VertexPositionColor(Vector3(), Color(255.0f, 1.0f, 1.0f)),
